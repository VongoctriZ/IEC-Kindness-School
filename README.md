...
Mạng xã hội học đường gamification dành cho học sinh.  
...
```bash
# 1. Clone repo
git clone https://github.com/your-username/kindness-school.git
cd kindness-school
...
- [`ROADMAP.md`](project-docs/ROADMAP.md) — tiến độ và kế hoạch phát triển
- [`PROJECT_REPORT.md`](project-docs/PROJECT_REPORT.md) — báo cáo tổng hợp cho nhóm
- [`BACKLOG.md`](project-docs/BACKLOG.md) — chi tiết sub-task và bug backlog
